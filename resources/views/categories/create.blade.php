...
<style>
    /* =========================================
   STYLE KHUSUS FORMULIR (TAMBAH KATEGORI, BUAT & EDIT JASA)
   ========================================= */
...
<div class="srvform-wrapper">
    ...
    <div class="srvform-card">
        <div class="srvform-header">
            ...
            <p>Buat kategori baru untuk mengelompokkan jenis-jenis jasa.</p>
        </div>

        {{-- Global Error Handler --}}
        @if ($errors->any())
            <div class="srvform-alert-danger">
                <strong>Oops!</strong> Ada kesalahan pada input data. Silakan periksa kembali form di bawah.
            </div>
        @endif

        <form method="POST" action="{{ url('/categories') }}" class="srvform-body">
            @csrf
